...
package C3
{
	...
	public class Quaternion
	{
		...
		public function fromEuler( _vec:Vector3D ):void{
			var heading:Number = _vec.y* DEG_TO_RAD;
			var attitude:Number = _vec.z* DEG_TO_RAD;
			var bank:Number = _vec.x* DEG_TO_RAD;
		...
		public function toRotationMatrix():Matrix3D
		{
			...
			var rawData:Vector.<Number> = Matrix3DUtils.RAW_DATA;
